...
--
-- Table structure for table `tb_capital`
--
...
--
-- Dumping data for table `tb_capital`
--

LOCK TABLES `tb_capital` WRITE;
/*!40000 ALTER TABLE `tb_capital` DISABLE KEYS */;
INSERT INTO `tb_capital` VALUES (1,'LA','Vientiane'),(2,'MM','Naypyidaw'),(3,'MX','Putra Jaya'),(4,'MY','Malaysia'),(5,'LB','Beirut'),(6,'JP','Tokyo'),(7,'IT','Rome');
/*!40000 ALTER TABLE `tb_capital` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_country` VALUES ('IT','Italy'),('JP','Japan'),('LA','Laos'),('MM','Myanmar'),('MX','Mexico'),('MY','Malaysia');
...
-- Dump completed on 2019-10-18 23:29:13
