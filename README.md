# Repositori Tugas Praktikum Sistem Basis Data I 2019
...
4. Seluruh berkas **Tugas Praktikum** pertemuan ke-_**n**_ dismpan pada direktori _**Praktikum_n**_.
   > - Berkas tugas berupa  `.sql` dan `.txt`.
   > - `.sql` merupakan hasil *export* `database` anda.
   > - `.txt` merupakan `query` yang anda gunakan dalam membuat `database` dan `table`.
...
## Sample Database
[Sample Database (SQL)](mysqlsampledatabase.zip)   
