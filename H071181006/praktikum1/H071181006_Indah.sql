...
--
-- Table structure for table `mahasiswa_penguji`
--

DROP TABLE IF EXISTS `mahasiswa_penguji`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mahasiswa_penguji` (
  `nama` varchar(200) NOT NULL,
  `nip` varchar(50) NOT NULL,
  `kode_dosen` varchar(10) NOT NULL,
  `status` varchar(100) NOT NULL,
  `nama_prodi` varchar(200) NOT NULL,
  `jenis_penguji` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mahasiswa_penguji`
--

LOCK TABLES `mahasiswa_penguji` WRITE;
/*!40000 ALTER TABLE `mahasiswa_penguji` DISABLE KEYS */;
/*!40000 ALTER TABLE `mahasiswa_penguji` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-10-12 20:26:53
