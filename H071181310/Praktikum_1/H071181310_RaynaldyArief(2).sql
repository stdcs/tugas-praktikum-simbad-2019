...
--
-- Table structure for table `tsk_pebimbing`
--

DROP TABLE IF EXISTS `tsk_pebimbing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tsk_pebimbing` (
...
--
-- Dumping data for table `tsk_pebimbing`
--

LOCK TABLES `tsk_pebimbing` WRITE;
/*!40000 ALTER TABLE `tsk_pebimbing` DISABLE KEYS */;
/*!40000 ALTER TABLE `tsk_pebimbing` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-10-06 21:18:16
