...
CREATE TABLE `mahasiswa` (
  ...
  CONSTRAINT `mahasiswa_ibfk_1` FOREIGN KEY (`kode_prodi`) REFERENCES `prodi` (`kode`),
  CONSTRAINT `mahasiswa_ibfk_2` FOREIGN KEY (`jalur_masuk`) REFERENCES `jalur_masuk` (`kode`),
  CONSTRAINT `mahasiswa_ibfk_3` FOREIGN KEY (`kode_fakultas`) REFERENCES `fakultas` (`kode`)
...
INSERT INTO `mahasiswa` VALUES (24,'H',07,2018,'3','Nurul Fitrihasari'),(25,'H',07,2018,'3','Nur Aviva Iriawan');
...
INSERT INTO `nim` VALUES ('Muh. Ikhsan Ilma','H071181301'),('Nurul Fitrihasari','H071181302'),('Muh. Ikhsan Ilma','H071181321'),('Nurul Fitrihasari Ramadhani','H071181315'),('Nurul Fitrihasari Ramadhani','H071181315'),('Aviva Nur Iriawan','H071181313'),('Nurul Fitrihasari Ramadhani','H071181315'),('Nurul Fitrihasari Ramadhani','H071181305'),('Nurul Fitrihasari Ramadhani','H071181322'),('Nur Aviva Iriawan','H071181325');
...
-- Dump completed on 2019-10-29 21:47:03
