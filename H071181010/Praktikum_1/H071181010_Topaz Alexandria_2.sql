...
--
-- Host: localhost    Database: ddl_assignment
-- ------------------------------------------------------
...
CREATE TABLE `skripsi_mahasiswa` (
  ...
  `dosen_pembimbing` varchar(200) DEFAULT NULL,
...
CREATE TABLE `tnilai` (
  ...
  `bobot_nilai` decimal(3,0) DEFAULT NULL,
...
CREATE TABLE `tseminar` (
  ...
  `id_nilai` int(2) DEFAULT NULL,
  `jenis_seminar` char(1) DEFAULT NULL,
  `id_mahasiswa` int(255) DEFAULT NULL,
  `status` varchar(20) DEFAULT NULL,
  `id_pembimbing` int(255) DEFAULT NULL,
  `id_penguji` int(255) DEFAULT NULL,
...
-- Dump completed on 2019-10-09  9:33:07
