...
CREATE TABLE `tmahasiswa` (
  `id_mahasiswa` int(255) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) NOT NULL,
  `nim` varchar(10) NOT NULL,
  `jk` char(1) NOT NULL,
...
INSERT INTO `tnilai` VALUES (4,'A',4.00),(5,'A-',3.80),(6,'B',3.50);
...
CREATE TABLE `tpenguji` (
  `id_penguji` int(255) NOT NULL AUTO_INCREMENT,
  `id_dosen` int(255) NOT NULL,
  `jenis_penguji` char(1) NOT NULL,
...
CREATE TABLE `tsemester` (
  `id_semester` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tseminar` (
  `id_seminar` int(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tseminar` VALUES (4,'2019-10-06',4,'A',4,'Sementara',4,4);
...
CREATE TABLE `tsidang` (
  `id_sidang` int(5) NOT NULL AUTO_INCREMENT,
  `id_mahasiswa` int(255) NOT NULL,
...
CREATE TABLE `tsk_pembimbing` (
  `id_SK` int(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tskripsi` (
  `id_skripsi` int(5) NOT NULL AUTO_INCREMENT,
  `id_mahasiswa` int(255) NOT NULL,
...
-- Dump completed on 2019-10-10 15:42:14
